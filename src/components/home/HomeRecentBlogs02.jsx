      ...
      <section className="py-6 md:py-[50px] lg:py-[100px]">
        <div className="w-full h-full grid max-w-screen-xl px-4 py-4 mx-auto">
          <div className="text-center mb-8 md:mb-16">
            <h1 className="text-white text-2xl md:text-6xl font-bold py-2">
              Our Recent Blogs
            </h1>
              ...
              <Link to={`/blog/${blog.id}`} key={blog.id}>
                <div className="w-full group overflow-hidden relative rounded-md">
                  <img
                    ...
                    alt=""
                  />
                  <div className="w-full h-full p-5 absolute bottom-[-5px] left-0 bg-gradient-to-t from-[#183C4B] via-[#000000be] to-transparent">
